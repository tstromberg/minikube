...
func TestDisplay(t *testing.T) {
	...
	tests := []struct {
		...
		{
			issue:       Problem{ID: "example", URL: "example.com"},
...
`,
		...
		{
			issue:       Problem{ID: "example", URL: "example.com", Issues: []int{0, 1}, Advice: "you need a hug"},
...
`,
		...
		{
			issue:       Problem{ID: "example", URL: "example.com", Issues: []int{0, 1}},
